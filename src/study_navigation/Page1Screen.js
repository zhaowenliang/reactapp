  ...
  render() {
    ...
    return (
      <>
        ...
        <Button title="Go to Page1" onPress={() => navigation.navigate(RoutePage.PAGE1, { name: 'Devio' })} />
        ...
        <Button title="Go to Page4" onPress={() => navigation.navigate(RoutePage.PAGE4)} />

        <View style={{ height: 10 }} />

        <Image source={require('../image/ic_vip.png')} style={{ alignSelf: 'center', margin: 4 }} />
